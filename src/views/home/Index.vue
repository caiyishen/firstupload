        ...
        <a-row :gutter="24">
          <a-col :md="6"
            ...
            <a-form-item label="名称">
              <a-input v-model="queryParam.jobFairName"
                       placeholder="请输入名称" />
            </a-form-item>
          </a-col>
          <a-col :md="6"
            ...
            <a-form-item label="模板内容">
              <a-input v-model="queryParam.jobFairName1"
                       placeholder="请输入模板内容" />
            </a-form-item>
          </a-col>
          <a-col :md="6"
...
export default {
  ...
  data () {
    return {
      ...
      selectedRowKeys: [],
      url: {
        list: '/rencai/back/jobFair/jobfairModule/jobFairList',
  ...
  mounted () {
    // console.log(this.$route, 'indexraoute1');
  },
  methods: {
    handleImportExcel () {
    },
